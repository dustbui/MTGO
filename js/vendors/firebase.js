...
(function () {
    var h = "undefined" != typeof window && window === this ? this : "undefined" != typeof global ? global : this,
        ...
        fa = function (a, b) {
            return -1 !== r(this, a, "includes").indexOf(a, b || 0)
        },
        ga = function (a, b) {
    ...
    var la = function (a, b, c, d) {
        ...
        D = function (a, b, c) {
            w(a) || la("Expected function but got %s: %s.", [v(a), a], b, Array.prototype.slice.call(arguments, 2))
        };
    ...
    var N = function (a, b, c) {
            0 == a.b && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.b = 1, xa(c, a.Y, a.Z, a) || (a.K = c, a.b = b, a.u = null, Aa(a), 3 != b || Ca(a, c)))
        },
        xa = function (a, b, c, d) {
    ...
    O.prototype.N = function () {
        for (var a; a = Ea(this);) {
            ...
            if (a.child) a.child.u = null, Fa(a, b, c);
                ...
                a.w ? a.c.call(a.context) : Fa(a, b, c)
            } catch (e) {
                Ga.call(null, e)
            }
            va.put(a)
        ...
        return new O(function (b, c) {
            ...
            if (d)
                for (var f = function (a, c) {
                        ...
                        c(a)
                    }, g = 0, n; g < a.length; g++) n = a[g], ya(n, y(f, g), k);
            else b(e)
        })
    };
        ...
        var b = {},
            ...
            e = {
                initializeApp: function (a, c) {
                    ...
                    void 0 != g.INTERNAL && void 0 != g.INTERNAL.getToken || P(g, {
                        INTERNAL: {
                            getToken: function () {
...
(function () {
    ...
    Eb.prototype.qc = !0;
    Eb.prototype.oc = function () {
        return this.da
    };
    Eb.prototype.toString = function () {
        return "SafeHtml{" + this.da + "}"
    };
    var Fb = function (a) {
    ...
    var Sb = function (a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.Va && f.listener == b && f.zb == !!c && f.Ib == d) return e
        }
        return -1
    };
    ...
    var tc = function (a) {
        return a.Jc || (a.Jc = a.ad())
    };
    var uc, vc = function () {};
    q(vc, sc);
    vc.prototype.hc = function () {
        var a = wc(this);
    ...
    var B = function (a, b) {
        ...
        Ec = Bc(16777216),
        Fc = function (a) {
            if (-1 == a.h) return -Fc(D(a));
            for (var b = 0, c = 1, d = 0; d < a.i.length; d++) b += Gc(a, d) * c, c *= 4294967296;
            return b
        };
    ...
    var G = function (a, b) {
            return 0 > b ? 0 : b < a.i.length ? a.i[b] : a.h
        },
        Gc = function (a, b) {
            var c = G(a, b);
    ...
    B.prototype.compare = function (a) {
        a = Ic(this, a);
        return -1 == a.h ? -1 : F(a) ? 0 : 1
    };
    var D = function (a) {
        for (var b = a.i.length, c = [], d = 0; d < b; d++) c[d] = ~a.i[d];
        return (new B(c, ~a.h)).add(Dc)
    };
    ...
    var Jc = function (a, b) {
        ...
        Lc = function (a, b) {
            for (var c = Math.max(a.i.length, b.i.length), d = [], e = 0; e < c; e++) d[e] = G(a, e) | G(b, e);
            return new B(d, a.h | b.h)
        };
    ...
    var Kc = function (a, b) {
        for (var c = b >> 5, d = b % 32, e = a.i.length - c, f = [], g = 0; g < e; g++) f[g] = 0 < d ? G(a, g + c) >>> d | G(a, g + c + 1) << 32 - d : G(a, g + c);
        return new B(f, a.h)
    };
    var Mc = function (a, b) {
        this.jb = a;
    ...
    Mc.prototype.Bb = function (a) {
        return this.ha == a.ha && this.jb.Bb(Xa(a.jb))
    };
    var Pc = function (a) {
            try {
                var b;
    ...
    Oc.prototype.toString = function () {
        ...
        for (var a = Gc(this.jb, 0), b = [], c = 3; 0 <= c; c--) b[c] = String(a & 255), a >>>= 8;
        return this.ya = b.join(".")
    };
    var Nc = function (a) {
        var b = C;
        if (a instanceof B) {
    ...
    var ld = function (a, b, c) {
            0 == a.A && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.A = 1, qd(c, a.Be, a.Ce, a) || (a.fa = c, a.A = b, a.m = null, zd(a), 3 != b || c instanceof md || Ad(a, c)))
        },
        qd = function (a, b, c, d) {
    ...
    var yd = function (a, b, c, d) {
            ...
            if (b.child) b.child.m = null, Cd(b, c, d);
                ...
                b.bb ? b.za.call(b.context) : Cd(b, c, d)
            } catch (e) {
                Dd.call(null, e)
            }
            od.put(b)
        ...
        Cd = function (a, b, c) {
            2 == b ? a.za.call(a.context, c) : a.Pa && a.Pa.call(a.context, c)
        },
        Ad = function (a, b) {
            a.Hb = !0;
            hd(function () {
    ...
    */
    ...
    var Vd = function (a) {
            ...
            d.onload = d.onreadystatechange = function () {
                d.readyState && "loaded" != d.readyState && "complete" != d.readyState || (Sd(d, b.Ge || !1, g), f.callback(null))
            };
            d.onerror = function () {
                Sd(d, !0, g);
    ...
    h.dispatchEvent = function (a) {
        ...
        if (c) {
            b = [];
            for (var d = 1; c; c = c.uc) b.push(c), v(1E3 > ++d, "infinite loop")
        }
        c = this.Fd;
        d = a.type || a;
        if (m(a)) a = new Lb(a, c);
    ...
    var Xd = function (a) {
        v(a.T, "Event target is not initialized. Did you call the superclass (goog.events.EventTarget) constructor?")
    };
    ...
    h.O = function () {
        de(this);
        for (var a = [], b = 0; b < this.o.length; b++) a.push(this.U[this.o[b]]);
        return a
    };
    h.ba = function () {
        de(this);
    ...
    ce.prototype.remove = function (a) {
        return ee(this.U, a) ? (delete this.U[a], this.j--, this.ha++, this.o.length > 2 * this.j && de(this), !0) : !1
    };
    var de = function (a) {
        if (a.j != a.o.length) {
    ...
    var ne = new me("SEVERE", 1E3),
        ...
        pe = new me("FINE", 500);
    le.prototype.getParent = function () {
        return this.m
    };
    le.prototype.qd = function (a) {
        this.mb = a
    };
    var qe = function (a) {
        if (a.mb) return a.mb;
    ...
    L.prototype.send = function (a, b, c, d) {
        ...
        this.qe && "onprogress" in this.a && (this.a.onprogress = p(function (a) {
            this.hd(a, !0)
        }, this), this.a.upload && (this.a.upload.onprogress = p(this.hd, this)));
        try {
        ...
        "withCredentials" in this.a && this.a.withCredentials !== this.xd && (this.a.withCredentials =
            this.xd);
        try {
            De(this), 0 < this.Ya && (this.$b = Ee(this.a), K(this.K, Ce(this, "Will abort after " + this.Ya + "ms if incomplete, xhr2 " + this.$b)), this.$b ? (this.a.timeout = this.Ya, this.a.ontimeout = p(this.wb, this)) : this.Yb = ue(this.wb, this.Ya, this)), K(this.K, Ce(this, "Sending request")), this.Kb = !0, this.a.send(a), this.Kb = !1
        } catch (f) {
            K(this.K, Ce(this, "Send error: " + f.message)), this.F(5, f)
        }
    };
    var Ee = function (a) {
    ...
    L.prototype.wb = function () {
        "undefined" != typeof aa && this.a && (this.lb = "Timed out after " + this.Ya + "ms, aborting", K(this.K, Ce(this, this.lb)), this.dispatchEvent("timeout"), this.abort(8))
    };
    ...
    L.prototype.abort = function () {
        this.a && this.ja && (K(this.K, Ce(this, "Aborting")), this.ja = !1, this.xa = !0, this.a.abort(), this.xa = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), Ge(this))
    };
    ...
    L.prototype.jd = function () {
        this.isDisposed() || (this.rc || this.Kb || this.xa ? He(this) : this.oe())
    };
        ...
        if (a.ja && "undefined" != typeof aa)
            ...
            try {
                ...
                if (d) a.dispatchEvent("complete"), a.dispatchEvent("success");
                    ...
                    var k;
                    try {
                        k = 2 < Ie(a) ? a.a.statusText : ""
                    } catch (t) {
                        K(a.K, "Can not get status: " + t.message), k = ""
                    }
                    a.lb = k + " [" + Je(a) + "]";
                    Fe(a)
                }
    ...
    var Ke = function (a, b) {
        ...
        Le = function (a) {
            try {
                ...
                return K(a.K, "Can not get responseText: " + b.message), ""
            }
        },
        Ce = function (a, b) {
            return b + " [" + a.cd + " " + a.Lb + " " + Je(a) + "]"
        };
    var Me = function (a, b) {
    ...
    var Ne = function (a, b, c) {
        ...
        M = function (a) {
            if (a.ge) throw Error("Tried to modify a read-only Uri");
        };
    ...
    var Ze = function (a, b) {
        ...
        Te = function (a, b, c) {
            return m(a) ? (a = encodeURI(a).replace(b, $e), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
        },
        $e = function (a) {
            a = a.charCodeAt(0);
        ...
        af = function (a) {
            a.l || (a.l = new ce, a.j = 0, a.D && xe(a.D, function (b, c) {
    ...
    var df = function (a, b) {
        ...
        ef = function (a) {
            ...
            if (u(b, "safari/") && !u(b, "chrome/")) return "Safari";
        ...
        lf = function (a) {
            var b = kf(void 0);
            return ("Browser" === b ? ef(navigator.userAgent || "") : b) + "/JsCore/" + a
        },
        mf = function (a) {
            a = a.split(".");
        ...
        nf = function () {
            return !(!l.location || !l.location.protocol || "http:" != l.location.protocol && "https:" != l.location.protocol || "ReactNative" === kf())
        },
        of = function () {
            ...
            if (b && b.length && c && 2 ==
                c.length) {
                if (8 > parseInt(c[1], 10)) return !1
            } else if ("Firefox" == ef(a)) return !1;
            return !0
        },
        pf = function (a) {
    ...
    var zf = function (a, b, c, d, e) {
        ...
        this.F = e || null;
        if (this.$a || this.F) {
            if (this.$a && this.F) throw new Q("invalid-auth-event");
            if (this.$a && !this.Ub) throw new Q("invalid-auth-event");
        } else throw new Q("invalid-auth-event");
    };
    zf.prototype.getError = function () {
        return this.F
    };
    ...
    var Df = function (a) {
        ...
        return {
            postBody: cf(b).toString(),
            requestUri: nf() ? window.location.href : "http://localhost"
        }
    };
    ...
    var Ff = function (a, b) {
            ...
            c || (d.prototype.addScope = function (a) {
                Ia(this.Cc, a) || this.Cc.push(a)
            });
            d.prototype.Gb = function () {
                return Oa(this.Cc)
            };
            d.credential = function (b, d) {
                return new Bf(a, c, b, d)
            };
            tf(d, {
                PROVIDER_ID: a
            });
    ...
    Kf.prototype.Fb = function (a) {
        return R(a, Lf, {
            email: this.Ab,
            password: this.vc
        })
    };
    Kf.prototype.dd = function (a, b) {
        return R(a, Mf, {
            idToken: b,
            email: this.Ab,
            password: this.vc
    ...
    var Of = {
        ...
        Pf = function (a) {
            ...
            a = a && a.oauthIdToken;
            for (var e in Of)
                if (Of[e].PROVIDER_ID == b) try {
                    return Of[e].credential({
                        accessToken: c,
                        idToken: a,
                        oauthToken: c,
                        oauthTokenSecret: d
    ...
    var S = function (a, b, c) {
        ...
        Vf = function (a,
            b, c, d, e, f, g) {
            ff() ? a = p(a.xe, a) : (Tf || (Tf = new H(function (a, b) {
                Uf(a, b)
            })), a = p(a.we, a));
            a(b, c, d, e, f, g)
        };
    S.prototype.xe = function (a, b, c, d, e, f) {
        var g = "ReactNative" === kf() ? new L : new L(this.Id),
            k;
        f && (g.Ya = Math.max(0, f), k = setTimeout(function () {
    ...
    var Wf = "__fcb" + Math.floor(1E6 * Math.random()).toString(),
        Uf = function (a, b) {
            ...
            }, Nd(Vd("https://apis.google.com/js/client.js?onload=" + Wf), function () {
    ...
    var Yf = function (a, b) {
            return new H(function (c, d) {
                "refresh_token" == b.grant_type && b.refresh_token || "authorization_code" == b.grant_type && b.code ? Vf(a, a.te + "?key=" + encodeURIComponent(a.v), function (a) {
                    a ? a.error ? d(Xf(a)) : a.access_token && a.refresh_token ? c(a) : d(new Q("internal-error")) : d(new Q("network-request-failed"))
                }, "POST", cf(b).toString(), a.ue, a.ve) : d(new Q("internal-error"))
            })
        },
        Zf = function (a) {
            var b = {},
        ...
        $f = function (a, b, c, d, e) {
            ...
            return new H(function (b, e) {
                Vf(a, f, function (a) {
                    a ? a.error ? e(Xf(a)) : b(a) : e(new Q("network-request-failed"))
                }, c, Zf(d), a.Tc, a.Rd)
            })
        },
        ag = function (a) {
        ...
        dg = function (a, b) {
            return R(a, cg, {
                identifier: b,
                continueUri: nf() ? window.location.href : "http://localhost"
            }).then(function (a) {
    ...
    var ng = function (a, b, c) {
        ...
        pg = function (a) {
            if (a.needConfirmation) throw (a && a.email ? new Qf(a.email, Pf(a), a.message) : null) || new Q("account-exists-with-different-credential");
            if (!a.idToken) throw new Q("internal-error");
        },
        Cf = function (a, b) {
            return R(a, qg, b)
    ...
    var ug = {
        ...
        function (a, b, c) {
            ...
            var d = b.Zd || "POST",
                e;
            return I(c).then(b.w).then(function () {
                b.pa && (c.returnSecureToken = !0);
                return $f(a, b.endpoint, d, c, b.Hd || !1)
            }).then(function (a) {
                return e = a
            }).then(b.oa).then(function () {
                if (!b.Xa) return e;
                if (!(b.Xa in e)) throw new Q("internal-error");
                return e[b.Xa]
            })
        },
        Xf = function (a) {
    ...
    Ag.prototype.value = function () {
        return this.L
    };
    Ag.prototype.rd = function (a) {
        this.L.style = a;
        return this
    };
    var Cg = function (a) {
        ...
        Gg = function (a, b) {
            a.ne.then(function () {
                a.pc.register("authEvent", b, mf("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"))
            })
        },
        ...
        Fg = function () {
            return Dg ? Dg : Dg = new H(function (a, b) {
                var c = function () {
                    mf("gapi.load")("gapi.iframes", function () {
                        a()
                    })
                };
                mf("gapi.iframes.Iframe") ? a() : mf("gapi.load") ? c() : (l[Hg] = function () {
                    mf("gapi.load") ? c() : b()
                }, Nd(Vd("https://apis.google.com/js/api.js?onload=" + Hg), function () {
                    b()
                }))
            })
        };
    ...
    var Og = function (a) {
        if (!a.g) return !1;
        try {
            return a.g.setItem("__sak", "1"), a.g.removeItem("__sak"), !0
        } catch (b) {
            return !1
        }
    };
    ...
    var Rg = function (a) {
        ...
        if (!this.g) throw new Q("internal-error", "The React Native compatibility library was not found.");
    };
    h = Rg.prototype;
    h.get = function (a) {
        return I(this.g.getItem(a)).then(function (a) {
            return a && qf(a)
        })
    };
    h.set = function (a, b) {
        return I(this.g.setItem(a, pf(b)))
    };
    h.remove = function (a) {
        return I(this.g.removeItem(a))
    };
    h.Ia = function () {};
    h.Ua = function () {};
    var Sg = function () {
    ...
    kh.prototype.unsubscribe = function (a) {
    ...
    kh.prototype.getRedirectResult = function () {
        return this.sb.getRedirectResult()
    };
    ...
    ih.prototype.xc = function (a) {
        this.X || nh(this, !0, null, a.getError());
        return I()
    };
    ih.prototype.yc = function (a, b) {
        ...
        return e(a.$a, a.Ub).then(function (a) {
            c.X || nh(c, f, a, null)
        }).N(function (a) {
            c.X || nh(c, f, null, a)
        })
    ...
    var nh = function (a, b, c, d) {
        b ? d ? (a.X = function () {
            return J(d)
        }, a.Rb && a.Rb(d)) : (a.X = function () {
            return I(c)
        }, a.Ta && a.Ta(c)) : (a.X = function () {
            return I({
                user: null
            })
        }, a.Ta && a.Ta({
    ...
    ih.prototype.getRedirectResult = function () {
        var a = this;
        this.Kc || (this.Kc = new H(function (b, c) {
            a.X ? a.X().then(b, c) : (a.Ta = b, a.Rb = c, uh(a))
        }));
        return this.Kc
    };
    var uh = function (a) {
    ...
    jh.prototype.xc = function (a, b) {
        b.Ea(a.sa, null, a.getError(), a.va);
        return I()
    };
    jh.prototype.yc = function (a, b) {
        var c = a.va,
            d = a.sa;
        return b.fb(d, c)(a.$a, a.Ub).then(function (a) {
            b.Ea(d, a, null, c)
        }).N(function (a) {
            b.Ea(d, null, a, c)
        })
    ...
    vh.prototype.getToken = function (a) {
        return a || !this.Ha || la() > this.La - 3E4 ? this.ea ? yh(this, {
            grant_type: "refresh_token",
            refresh_token: this.ea
        }) : I(null) : I({
            accessToken: this.Ha,
            expirationTime: this.La,
            refreshToken: this.ea
    ...
    var Bh = function (a, b) {
        ...
        Eh = function (a) {
            for (var b = [], c = 0; c < a.Vb.length; c++) b.push(a.Vb[c](a));
            return sd(b).then(function () {
                return a
            })
        },
        Fh = function (a) {
            a.s && !a.Ob && (a.Ob = !0, a.s.subscribe(a))
        },
        Ch = function (a, b) {
            tf(a, {
                uid: b.uid,
    ...
    var Gh = function () {},
        Hh = function (a) {
            return I().then(function () {
                if (a.Ld) throw new Q("app-deleted");
            })
        },
        Ih = function (a) {
        ...
        Kh = function (a, b) {
            b && (Jh(a, b.providerId), a.providerData.push(b))
        },
        Jh = function (a, b) {
    ...
    V.prototype.copy = function (a) {
        ...
        b != a && (tf(this, {
            ...
            Kh(b, a)
        }), this.ra = a.ra, P(this, "refreshToken", this.ra.ea))
    };
    V.prototype.reload = function () {
        var a = this;
        return Hh(this).then(function () {
            return Mh(a).then(function () {
                return Eh(a)
            }).then(Gh)
        })
    };
    var Mh = function (a) {
        return a.getToken().then(function (b) {
            var c = a.isAnonymous;
            return Nh(a, b).then(function () {
                c || Lh(a, "isAnonymous", !1);
                return b
            }).N(function (b) {
                "auth/user-token-expired" == b.code && (a.dispatchEvent(new Ah("userDeleted")), Oh(a));
                throw b;
            })
        })
    };
    ...
    var Ph = function (a, b) {
        b.idToken && a.bd != b.idToken && (xh(a.ra, b), a.ma(), Bh(a, b.idToken))
    };
    V.prototype.ma = function () {
        this.dispatchEvent(new Ah("tokenChanged"))
    };
    var Nh = function (a, b) {
        return R(a.c, xg, {
            idToken: b
    ...
    var Rh = function (a, b) {
        return Mh(a).then(function () {
            if (Ia(Ih(a), b)) return Eh(a).then(function () {
    ...
    h.link = function (a) {
        var b = this;
        return this.f(Rh(this, a.provider).then(function () {
            return b.getToken()
        }).then(function (c) {
            return a.dd(b.c, c)
        }).then(p(this.Sc, this)))
    ...
    h["delete"] = function () {
        ...
        return this.f(this.getToken().then(function (b) {
            ...
            a.dispatchEvent(new Ah("userDeleted"))
        })).then(function () {
            Oh(a)
        })
    };
    h.Mc = function (a, b) {
        return "linkViaPopup" == a && (this.ca || null) == b && this.V || "linkViaRedirect" == a && (this.Qb || null) == b ? !0 : !1
    };
    h.Ea = function (a, b, c, d) {
        "linkViaPopup" == a && d == (this.ca || null) && (c && this.Aa ? this.Aa(c) : b && !c && this.V && this.V(b), this.Ba && (this.Ba.cancel(), this.Ba = null), delete this.V, delete this.Aa)
    };
    h.fb = function (a, b) {
        return "linkViaPopup" == a && b == (this.ca || null) || "linkViaRedirect" == a && (this.Qb || null) == b ? p(this.Od, this) : null
    };
    h.Db = function () {
        return this.uid + ":::" + Math.floor(1E9 * Math.random()).toString()
    };
    h.linkWithPopup = function (a) {
        ...
        var f = gf(e, c && c.rb, c && c.qb),
            c = Rh(this, a.providerId).then(function () {
                return Eh(b)
            }).then(function () {
                b.Na();
                return b.getToken()
            }).then(function () {
                if (!e) return ph(b.s, f, "linkViaPopup", a, d)
            }).then(function () {
    ...
    h.linkWithRedirect = function (a) {
        ...
        var b = this,
            c = null,
            d = this.Db(),
            e = Rh(this, a.providerId).then(function () {
                b.Na();
                return b.getToken()
            }).then(function () {
                b.Qb = d;
                ...
                b.Ca && (a = b.Ca, a = a.P.set(Sh, b.B(), a.$));
                return a
            }).then(function () {
                return qh(b.s, "linkViaRedirect", a, d)
            }).N(function (a) {
                c = a;
                if (b.Ca) return Th(b.Ca);
                throw c;
            }).then(function () {
                if (c) throw c;
            });
    ...
    h.Na = function () {
        if (this.s && this.Ob) return this.s;
        if (this.s && !this.Ob) throw new Q("internal-error");
    ...
    V.prototype.B = function () {
        var a = {
            ...
            appName: this.ka,
            authDomain: this.S,
            stsTokenManager: this.ra.B(),
            redirectEventId: this.Qb || null
        };
        w(this.providerData, function (b) {
            a.providerData.push(uf(b))
        });
        return a
    };
    var Uh = function (a) {
    ...
    h.get = function (a) {
        var b = this;
        return Zh(this).then(function (c) {
    ...
    h.Fc = function () {
        ...
        this.Wb();
        var b = function () {
            a.wc = ve(1E3).then(p(a.ze, a)).then(function (b) {
                0 < b.length && w(a.ub, function (a) {
                    a(b)
                })
            }).then(b).N(function (a) {
    ...
    h = ci.prototype;
    h.G = function (a, b) {
        return this.le + this.pd + a.name + (b ? this.pd + b : "")
    };
    h.get = function (a, b) {
        var c = this.G(a, b);
        return this.nb && a.M ? this.ib.get(c).then(function (a) {
            return a && a.value
        }) : (a.M ? this.pb : this.Hc).get(c)
    };
    ...
    h.removeListener = function (a, b, c) {
        a = this.G(a, b);
        this.I[a] && (La(this.I[a], function (a) {
            return a == c
        }), 0 == this.I[a].length && delete this.I[a]);
        Ta(this.I) && this.Wb()
    };
    h.Fc = function () {
        this.nb ? this.ib.Ia(this.Yc) : (this.pb.Ia(this.ed), this.tb || fi(this))
    };
    var fi = function (a) {
            gi(a);
    ...
    ci.prototype.Wb = function () {
        this.nb ? this.ib.Ua(this.Yc) : (this.pb.Ua(this.ed), this.tb || gi(this))
    };
    ...
    ci.prototype.de = function (a) {
        w(a, p(this.Lc, this))
    };
    ci.prototype.Lc = function (a) {
        this.I[a] && w(this.I[a], function (a) {
            a()
        })
    };
    var hi = function (a) {
        ...
        Th = function (a) {
            return a.P.remove(Sh, a.$)
        },
        ii = function (a, b) {
            return a.P.get(Sh, a.$).then(function (a) {
                a && b && (a.authDomain = b);
                return Uh(a || {})
            })
        };
    var ji = function (a) {
        ...
        li = function (a) {
            return a.P.remove(ki, a.$)
        },
        mi = function (a, b) {
            return a.P.get(ki, a.$).then(function (a) {
                a && b && (a.authDomain = b);
                return Uh(a || {})
            })
        };
    var X = function (a) {
        ...
        try {
            this.ga = new ji(W(this).options.apiKey + ":" + W(this).name), this.Da = new hi(W(this).options.apiKey + ":" + W(this).name), this.C = this.f(oi(this))
        } catch (b) {
            this.C =
                J(b)
        }
    ...
    X.prototype.toJSON = function () {
        return {
            ...
            appName: W(this).name,
            currentUser: Z(this) && Z(this).B()
        }
    };
    X.prototype.Na = function () {
        return this.Md || J(new Q("auth-domain-config-required"))
    };
    var pi = function (a) {
    ...
    h.Ea = function (a, b, c, d) {
        "signInViaPopup" == a && this.ca == d && (c && this.Aa ? this.Aa(c) : b && !c && this.V && this.V(b), this.Ba && (this.Ba.cancel(), this.Ba = null), delete this.V, delete this.Aa)
    };
    h.fb = function (a, b) {
        return "signInViaRedirect" == a || "signInViaPopup" == a && this.ca == b && this.V ? p(this.Pd, this) : null
    };
    h.Pd = function (a, b) {
        var c = this,
            d = null,
    ...
    h.signInWithPopup = function (a) {
        ...
        var f = gf(e, c && c.rb, c && c.qb),
            c = this.Na().then(function (b) {
                if (!e) return ph(b, f, "signInViaPopup", a, d)
            }).then(function () {
    ...
    h.signInWithRedirect = function (a) {
        if (!nf()) return J(new Q("operation-not-supported-in-this-environment"));
        var b = this,
            c = this.Na().then(function () {
                return qh(b.s, "signInViaRedirect", a)
            });
        return this.f(c)
    };
    ...
    var ri = function (a) {
        ...
        oi = function (a) {
            var b = W(a).options.authDomain,
                c = vd(ri(a).then(function () {
                    return mi(a.ga, b)
                }).then(function (b) {
                    return b ? (b.Ca = a.Da, b.reload().then(function () {
                        return b
                    }).N(function (c) {
                        return "auth/network-request-failed" == c.code ? b : li(a.ga)
                    })) : null
                }).then(function (b) {
                    ni(a, b || null);
                    a.kb = !0;
    ...
    h.signInWithCredential = function (a) {
        var b = this;
        return this.C.then(function () {
            return si(b, a.Fb(b.c))
        })
    };
    h.signInAnonymously = function () {
        var a = Z(this),
            b = this;
        return a && a.isAnonymous ? I(a) : this.C.then(function () {
            return si(b, b.c.signInAnonymously())
        }).then(function (a) {
            Lh(a, "isAnonymous", !0);
            return b.Oa(a)
        }).then(function () {
    ...
    h.addAuthTokenListener = function (a) {
        this.cb.push(a);
        var b = this;
        this.kb && this.C.then(function () {
            a(Z(b) && Z(b)._lat || null)
        })
    };
    h.removeAuthTokenListener = function (a) {
        La(this.cb, function (b) {
            return b == a
        })
    };
    h["delete"] = function () {
    ...
    (function () {
        if ("undefined" !== typeof firebase && firebase.INTERNAL && firebase.INTERNAL.registerService) {
            ...
            firebase.INTERNAL.registerService("auth", function (a, c) {
                    ...
                    c({
                        INTERNAL: {
                            getToken: p(d.getToken, d),
                            addAuthTokenListener: p(d.addAuthTokenListener, d),
                            removeAuthTokenListener: p(d.removeAuthTokenListener, d)
                        }
                    });
                    return d
                },
...
(function () {
    ...
    Zb.prototype.Nc = function (a) {
        return this.path.e() ? new Zb(this.source, C, this.Ja.R(a)) : new Zb(this.source, D(this.path), this.Ja)
    };
    ...
    ac.prototype.Nc = function () {
        return this.path.e() ? new ac(this.source, C) : new ac(this.source, D(this.path))
    };
    ...
    function Zc(a) {
        for (var b = "", c = 0; c < arguments.length; c++) b = ea(arguments[c]) ? b + Zc.apply(null, arguments[c]) : "object" === typeof arguments[c] ? b + B(arguments[c]) : b + arguments[c], b += " ";
        return b
    }
    var wc = null,
        $c = !0;
    ...
    function hd(a) {
        return nd.test(a) && (a = Number(a), -2147483648 <= a && 2147483647 >= a) ? a : null
    }
    ...
    Gd.prototype.Nf = function (a, b) {
        if (null == a.Za || null == b.Za) throw Wc("Should only compare child_ events.");
    ...
    g.F = function (a, b, c, d, e, f) {
        ...
        return a.R(b).ca(c) ? a : a.Fb() < this.oa ? this.sa.Vb().F(a, b, c, d, e, f) : je(this, a, b, c, e, f)
    };
    g.za = function (a, b, c) {
        var d;
    ...
    Me.isAvailable = function () {
        return Ne || !Oe && "undefined" !== typeof document && null != document.createElement && !("object" === typeof window && window.chrome && window.chrome.extension && !/^chrome/.test(window.location.href)) && !("object" === typeof Windows && "object" === typeof Windows.Bg) && !0
    };
    g = Me.prototype;
    g.sd = function () {};
    g.Tc = function () {
    ...
    function hf(a) {
        ...
        }), a.Xc = a.D, df(a)) : (a.f("sending ping on secondary."), a.D.send({
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function gf(a) {
        a.Cb || 1 !== a.L || (a.f("sending ping on primary."), jf(a, {
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    Ye.prototype.close = function () {
        2 !== this.L && (this.f("Closing realtime connection."), this.L = 2, ef(this), this.ja && (this.ja(), this.ja = null))
    };
    ...
    function mf(a) {
        ...
        if (32 < a.Ta.length) throw Error(a.Se + "path specified exceeds the maximum depth that can be written (32) or object contains a cycle " + nf(a));
    }
    ...
    Qc.prototype.P = function (a) {
        null !== this.k && Le(this.k, function (b, c) {
            a(b, c)
        })
    };
    var wf = /[\[\].#$\/\u0000-\u001F\u007F]/,
    ...
    function Ef(a, b, c) {
        if (fd(c)) throw Error(Db(a, b, !1) + "is " + c.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
        if (!zf(c)) throw Error(Db(a, b, !1) + "must be a valid Firebase priority (a string, finite number, server value, or null).");
    }
    ...
    function Gf(a, b) {
        if (p(b) && !yf(b)) throw Error(Db(a, 2, !0) + 'was an invalid key: "' + b + '".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").');
    }

    function Hf(a, b) {
        if (!q(b) || 0 === b.length || xf.test(b)) throw Error(Db(a, 1, !1) + 'was an invalid path: "' + b + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');
    }
    ...
    g = Rf.prototype;
    g.Ra = function (a, b) {
        return new Rf(this.Oa, this.ba.Ra(a, b, this.Oa).Y(null, null, !1, null, null))
    };
    g.remove = function (a) {
        return new Rf(this.Oa, this.ba.remove(a, this.Oa).Y(null, null, !1, null, null))
    };
    g.get = function (a) {
    ...
    g.Y = function (a, b, c, d, e) {
        return new Wf(null != a ? a : this.key, null != b ? b : this.value, null != c ? c : this.color, null != d ? d : this.left, null != e ? e : this.right)
    };
    g.count = function () {
    ...
    g.Ye = function (a, b, c) {
        return (c = fg(this, c)) ? (a = Tf(c, new K(a, b))) ? a.name : null : Tf(this.k, a)
    };
    ...
    g.Yb = function (a, b) {
        ...
        for (var c = this.k.Yb(a.name, Nc), d = Vf(c); null != d && 0 > b.compare(d, a);) R(c), d = Vf(c);
        return c
    };
    g.Ze = function (a) {
    ...
    g.$b = function (a, b) {
        ...
        for (var c = this.k.$b(a.name, Nc), d = Vf(c); null != d && 0 < b.compare(d, a);) R(c), d = Vf(c);
        return c
    };
    g.tc = function (a) {
    ...
    function M(a, b) {
        ...
        var m = He(f, Kc, function (a) {
            return a.name
        }, Mc);
        if (h) {
            var l = He(f, ke(N));
            return new P(m, M(c), new Fe({
                ".priority": l
            }, {
                ".priority": N
            }))
    ...
    g.matches = function (a) {
        return a instanceof og ? a.Qb && this.Qb ? a.Qb === this.Qb && a.ub === this.ub : !0 : !1
    };
    g.$e = function () {
        return null !== this.Qb
    };
    ...
    function qg(a) {
        ...
        if (a.g === ae) {
            if (a.ka) {
                if ("[MIN_NAME]" != de(a)) throw Error("Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().");
            ...
            if (null != b && !zf(b) || null != c && !zf(c)) throw Error("Query: When ordering by priority, the first argument passed to startAt(), endAt(), or equalTo() must be a valid priority value (null, a number, or a string).");
        } else if (H(a.g instanceof te || a.g === ze, "unknown index type."), null != b && "object" === typeof b || null != c && "object" === typeof c) throw Error("Query: First argument passed to startAt(), endAt(), or equalTo() cannot be an object.");
    }
    ...
    function yg(a, b, c) {
        ...
        var d = J(b);
        a = a.children.get(d);
        return null !== a ? (b = yg(a, D(b), c), null != b ? {
    ...
    function Tg(a, b, c) {
        ...
        b.children.ia(function (b, f) {
            ".priority" === b ? (H(null !== f.value, "Priority writes must always be leaf nodes"), d = f.value) : c = Tg(a.m(b), f, c)
        });
    ...
    g.Ba = function (a, b, c, d) {
        if (c || d) {
            var e = Sg(this.T, a);
            return !d && e.e() ? b : d || null != b || null != Qg(e, C) ? (e = ah(this.la, function (b) {
    ...
    g.sc = function (a, b) {
        ...
        } else e = Sg(this.T, a), Ja(Rg(e), function (a) {
            c = c.U(a.name, a.S)
        });
        return c
    };
    ...
    function fh(a, b) {
        for (var c = b instanceof L ? b : new L(b), d = a, e; null !== (e = J(c));) d = new eh(e, d, x(d.A.children, e) || new dh), c = D(c);
        return d
    }
    g = eh.prototype;
    g.Ea = function () {
    ...
    g.re = function (a, b, c) {
        this.ma ? sh(this, "o", a, b, c) : this.Lc.push({
            we: a,
            action: "o",
            data: b,
            G: c
    ...
    g.ff = function (a, b, c) {
        this.ma ? sh(this, "om", a, b, c) : this.Lc.push({
            we: a,
            action: "om",
            data: b,
            G: c
    ...
    g.xd = function (a, b) {
        this.ma ? sh(this, "oc", a, null, b) : this.Lc.push({
            we: a,
            action: "oc",
            data: null,
            G: b
    ...
    g.hg = function (a) {
        a ? (this.f("Browser went online."), this.Va = 1E3, this.Ia || mh(this, 0)) : (this.f("Browser went offline.  Killing connection."), this.Ia && this.Ia.close())
    };
    g.hf = function () {
    ...
    function Mh(a, b, c) {
        ...
        if (e) H(null == Vg(d.value), "If we're adding a query, it shouldn't be shadowed");
            ...
            for (e = Ag(d, function (a, b, c) {
                    ...
                    var d = [];
                    b && (d = d.concat(La(Wg(b), function (a) {
                        return a.W
                    })));
                    t(c, function (a) {
                        d = d.concat(a)
    ...
    function pf(a, b, c) {
        ...
        this.pd = new zh({
            Ae: function (a, b, c, d) {
                b = [];
                c = f.ie.j(a.path);
                c.e() || (b = Bh(f.pd, new Zb(Lg, a.path, c)), setTimeout(function () {
                    d("ok")
                }, 0));
                return b
            },
    ...
    g.Hb = function (a, b, c, d) {
        ...
        d ? c ? (b = oa(b, function (a) {
            return M(a)
        }), a = Jh(this.K, e, b, d)) : (b = M(b), a = Fh(this.K, e, b, d)) : c ? (d = oa(b, function (a) {
            return M(a)
        }), a = Eh(this.K, e, d)) : (d = M(b), a = Bh(this.K, new Zb(Lg, e, d)));
        d = e;
    ...
    function fi(a, b) {
        for (var c, d = a.nc; null !== (c = J(b)) && null === d.Ea();) d = fh(d, c), b = D(b);
        return d
    }
...
(function () {
    ...
    var ja = function (a, b, c) {
        ...
        function g(a) {
            Tb || (Tb = !0, N || (null !== l ? (a || (w = 2), clearTimeout(l), e(0)) : a || (w = 1)))
        }
        var h = 1,
            l = null,
            B = !1,
    ...
    var z = function (a, b) {
        ...
        Ma = function (a) {
            for (var b = null, c = [{
                    ...
                    ja: /^https?:\/\/firebasestorage\.googleapis\.com\/v[A-Za-z0-9_]+\/b\/([A-Za-z0-9.\-]+)\/o(\/([^?#]*).*)?$/i,
                    aa: {
                        bucket: 1,
                        path: 3
                    },
    ...
    var jc = function (a, b) {
        ...
        if (1 < c) {
            ...
            a instanceof jc ? (c = a.D(), d = a.w()) : (c = Ba(a), d = Aa(a));
    ...
    */
    ...
    var K = function (a, b) {
        ...
        if (d) {
            c = [];
            for (var e = 1; d; d = d.I) c.push(d), C(1E3 > ++e, "infinite loop")
        }
        a = a.ma;
        d = b.type || b;
    ...
    O.prototype.send = function (a, b, c, d) {
        ...
        this.ba && "onprogress" in this.a && (this.a.onprogress = t(function (a) {
            this.R(a, !0)
        ...
        "withCredentials" in this.a && this.a.withCredentials !== this.X && (this.a.withCredentials =
            this.X);
        try {
            td(this), 0 < this.i && (this.v = ud(this.a), M(this.u, P(this, "Will abort after " + this.i + "ms if incomplete, xhr2 " + this.v)), this.v ? (this.a.timeout = this.i, this.a.ontimeout = t(this.M, this)) : this.m = nd(this.M, this.i, this)), M(this.u, P(this, "Sending request")), this.j = !0, this.a.send(a), this.j = !1
        } catch (f) {
            M(this.u, P(this, "Send error: " + f.message)), sd(this, f)
        }
    };
    var ud = function (a) {
    ...
    O.prototype.M = function () {
        "undefined" != typeof aa && this.a && (this.h = "Timed out after " + this.i + "ms, aborting", this.J = 8, M(this.u, P(this, this.h)), K(this, "timeout"), vd(this, 8))
    };
    var sd = function (a, b) {
            a.c = !1;
        ...
        vd = function (a, b) {
            a.a && a.c && (M(a.u, P(a, "Aborting")), a.c = !1, a.f = !0, a.a.abort(), a.f = !1, a.J = b || 7, K(a, "complete"), K(a, "abort"), xd(a))
        };
    ...
    O.prototype.ca = function () {
        this.g || (this.H || this.j || this.f ? yd(this) : this.na())
    };
            ...
            try {
                if (Bd(a)) K(a, "complete"), K(a, "success");
                    ...
                    try {
                        ...
                        M(a.u, "Can not get status: " + c.message), b = ""
                    }
                    a.h = b + " [" + Q(a) + "]";
                    wd(a)
                }
    ...
    var Cd = function (a, b) {
        ...
        Dd = function (a) {
            try {
                ...
                return M(a.u, "Can not get responseText: " + b.message), ""
            }
        },
        Ed = function (a, b) {
        ...
        Gd = function (a) {
            function b(a, b) {
                b ? a(!1, new Id(!1, null, !0)) : Vc.W(function (b) {
                    ...
                    d.c = b;
                    var c = null;
                    null !== d.g && (b.ba = !0, c = Hc(b, "uploadprogress", function (a) {
    ...
    var W = function (a, b, c, d, e, f) {
            ...
            this.V = function (a) {
                g.a = null;
                "storage/canceled" === a.code ? (g.s = !0, pe(g)) : (g.g = a, V(g, "error"))
            };
            this.P = function (a) {
                g.a = null;
        ...
        qe = function (a) {
            "running" === a.b && null === a.a && (a.R ? null === a.m ? re(a) : a.s ? se(a) : a.B ? te(a) : ue(a) : ve(a))
        },
        we = function (a,
            b) {
    ...
    W.prototype.C = function () {
        return new A(this.j, this.f.size, ta(this.b), this.h, this, this.K)
    };
...
be(), be()], arguments);
    ...
    k.ga = function (a) {
        ...
        return Be(this.b, new z(this.a.bucket, b))
    };
    k.Fa = function () {
        var a;
        a = this.a.path;
    ...
    k.Ha = function () {
        return Be(this.b, new z(this.a.bucket, ""))
    };
    k.pa = function () {
